    ...
    <footer className="theme-footer-four">
      <div className="top-footer">
        <div className="container">
          <div className="row">
            <div
              className="col-lg-5 col-sm-6 col-12 gallery-widget"
              data-aos="fade-up"
            >
              <Link href="/">
                <a className="logo">
              ...
              <ul className="clearfix">
                <li>
                  <a href="#">
                    <img src="/assets/images/home/14.jpg" alt="" />
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="/assets/images/home/15.jpg" alt="" />
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="/assets/images/home/16.jpg" alt="" />
                  </a>
                </li>
              </ul>
            </div>
