...
const FooterWidget = ({ title, lists }) => {
  return (
    <div className="col-md-4 col-sm-6 col-12 footer-list">
              ...
              <div className="row">
                ...
                <FooterWidget
                  ...
                  lists={[
                    ...
                    { link: "/our-jobs", title: "Work Portfolio" },
                    { link: "/our-team", title: "Team" },
                    { link: "#", title: "Plan & Pricing" },
                    { link: "/blog-default", title: "News" },
                  ]}
                />
